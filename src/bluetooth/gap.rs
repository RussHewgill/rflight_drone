...
pub trait Commands {
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapSetNonDiscoverable) event
    /// is generated.
    ...
    /// Complete](crate::bluetooth::events::BlueNRGEvent::GapLimitedDiscoverableTimeout) event.
    ...
    /// # Generated evenst
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapSetDiscoverable) event is
    /// generated.
    ...
    /// # Generated evenst
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapSetDirectConnectable) event
    /// is generated.
    ...
    ///
    /// - A [Command
    ///   Complete](crate::bluetooth::events::command::ReturnParameters::GapSetAuthenticationRequirement) event
    ///   is generated.
    /// - If [`fixed_pin`](AuthenticationRequirements::fixed_pin) is [Request](Pin::Requested), then
    ///   a [GAP Pass Key](crate::bluetooth::events::BlueNRGEvent::GapPassKeyRequest) event is generated.
    ...
    ///
    /// - A [Command
    ///   Complete](crate::bluetooth::events::command::ReturnParameters::GapSetAuthorizationRequirement) event
    ///   is generated.
    /// - If authorization is required, then a [GAP Authorization
    ///   Request](crate::bluetooth::events::BlueNRGEvent::GapAuthorizationRequest) event is generated.
    ...
    /// Request](crate::bluetooth::events::BlueNRGEvent::GapPassKeyRequest) event.
    ///
    ...
    /// # Generated events
    ///
    /// - A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapPassKeyResponse) event is
    ///   generated.
    /// - When the pairing process completes, it will generate a
    ///   [PairingComplete](crate::bluetooth::events::BlueNRGEvent::GapPairingComplete) event.
    ...
    /// Request](crate::bluetooth::events::BlueNRGEvent::GapAuthorizationRequest) event.
    ///
    /// # Errors
    ///
    /// Only underlying communication errors are reported.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapAuthorizationResponse)
    /// event is generated.
    ...
    /// The device name characteristic and appearance characteristic are added by default and the
    /// handles of these characteristics are returned in the [event
    /// data](crate::bluetooth::events::command::GapInit).
    ///
    /// # Errors
    ///
    /// Only underlying communication errors are reported.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapInit) event is generated.
    fn init(
        &mut self,
        role: Role,
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapSetUndirectedConnectable)
    /// event is generated.
    ...
    /// Initiated](crate::bluetooth::events::BlueNRGEvent::GapPeripheralSecurityInitiated) vendor-specific event
    /// will be generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapGetSecurityLevel) event is
    /// generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapSetEventMask) event is
    /// generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapConfigureWhiteList) event
    /// is generated.
    ...
    fn terminate(
        &mut self,
        conn_handle: hci::ConnectionHandle,
        reason: hci::Status<crate::bluetooth::events::Status>,
    ) -> nb::Result<(), Error<Self::Error>>;
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::bluetooth::events::command::ReturnParameters::GapClearSecurityDatabase)
    /// event is generated.
    ...
    /// Lost](crate::bluetooth::events::BlueNRGEvent::GapBondLost) event if it wants the re-bonding to happen
    /// successfully. If this command is not given on receiving the event, the bonding procedure
    /// will timeout.
    ///
    /// # Errors
    ...
    /// procedure code set to [LimitedDiscovery](crate::bluetooth::events::GapProcedure::LimitedDiscovery) or a
    /// [timeout](crate::bluetooth::events::BlueNRGEvent::GapLimitedDiscoverableTimeout) happens. When the
    /// procedure is terminated due to any of the above reasons, a
    /// [ProcedureComplete](crate::bluetooth::events::BlueNRGEvent::GapProcedureComplete) event is returned with
    /// the procedure code set to [LimitedDiscovery](crate::bluetooth::events::GapProcedure::LimitedDiscovery).
    ///
    ...
    /// terminated when either the upper layers issue a command to terminate the procedure by
    /// issuing the command [`terminate_procedure`](Commands::terminate_procedure) with the
    /// procedure code set to [GeneralDiscovery](crate::bluetooth::events::GapProcedure::GeneralDiscovery) or a
    /// timeout happens. When the procedure is terminated due to any of the above reasons, a
    /// [ProcedureComplete](crate::bluetooth::events::BlueNRGEvent::GapProcedureComplete) event is returned with
    /// the procedure code set to [GeneralDiscovery](crate::bluetooth::events::GapProcedure::GeneralDiscovery).
    ///
    /// The device found when the procedure is ongoing is returned to the upper layers through the
    /// [LeAdvertisingReport](hci::event::Event::LeAdvertisingReport) event.
    ...
    /// [ProcedureComplete](crate::bluetooth::events::BlueNRGEvent::GapProcedureComplete) event is given to the
    ...
    /// procedure, a [ProcedureComplete](crate::bluetooth::events::BlueNRGEvent::GapProcedureComplete) event is
    /// returned with the procedure code set to
    /// [NameDiscovery](crate::bluetooth::events::GapProcedure::NameDiscovery).
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::bluetooth::events::command::ReturnParameters::GapTerminateProcedure) event
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::bluetooth::events::command::ReturnParameters::GapGetBondedDevices) event is
    /// generated.
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::bluetooth::events::command::ReturnParameters::GapSetBroadcastMode) event is
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::bluetooth::events::command::ReturnParameters::GapStartObservationProcedure)
    /// event is generated.
...
pub enum Error<E> {
    ...
    BadTerminationReason(hci::Status<crate::bluetooth::events::Status>),
...
pub enum Pin {
    ...
    /// Pass Key Request](crate::bluetooth::events::BlueNRGEvent::GapPassKeyRequest) event to the host.
    Requested,
